...
void procThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->plotSignal((*reinterpret_cast< QVector<double>(*)>(_a[1])),(*reinterpret_cast< QVector<double>(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (procThread::*_t)(QVector<double> , QVector<double> );
...
// SIGNAL 0
void procThread::plotSignal(QVector<double> _t1, QVector<double> _t2)
{
